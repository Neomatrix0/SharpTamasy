        ...
        while (rimani)
        {
            ...
            switch (opzione)
            {
                ...
                case "4":
                    ...
                    {
                        var existingTask = _service.GetTaskById(deleteId);
                ...
                case "5":
                    ...
                    {
                        var existingTask = _service.GetTaskById(editId);
                        ...
                        else
                        {
                            ...
                            {
                                _service.UpdateAssignedTo(editId, newAssignedTo);
                            }
                            ...
                            _service.UpdateTask(editId, updatedTitle, updatedDescription, updatedStatus);
                            ...
                            if (existingTask is BugTask)
                            {
                                ...
                                {
                                    _service.UpdateBugSeverity(editId, newSeverity.Value);
                                }
                            }
                            ...
                            if (existingTask is FeatureTask)
                            {
                                ...
                                {
                                    _service.UpdateFeaturePriority(editId, newPriority.Value);
                                }
                            }
